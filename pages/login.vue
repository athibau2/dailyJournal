      ...
      <v-row>
        ...
        <v-col class="intro-page" :cols="windowWidth < '850' ? null : '8'">
          <div class="full-intro">
            <h3 class="text-center" v-if="windowWidth >= 1060"
            >
              The new way to journal!
            </h3>
            <h4 class="text-center" v-else-if="windowWidth < 1060"
            >
              Write on, Write now: the new way to journal!
            </h4>
          ...
          <!-- Row 1 -->
          <v-row class="intro-rows" align="center" v-if="windowWidth >= 1060">
            <v-col cols="4">
              <span class="intro">
          ...
          <!-- Row 1 Small Window -->
          <v-row class="intro-rows" align="center" justify="center" v-else-if="windowWidth < 1060">
            <v-col>
          ...
          <!-- Row 2 Small Window -->
          <v-row class="intro-rows" align="center" v-else-if="windowWidth < 1060">
            <v-col>
              <p class="intro">
                Head to the "My Entries" page to see all of your journal submissions. Filter them by date or topic!
              </p>
            ...
            <v-row justify="center" align="center">
              ...
              >
                <v-card-title class="headline" style="color: #575757">
                    <em>Sign In Here {{windowWidth}}</em>
                </v-card-title>
                <v-card-text>
                    <v-text-field
                        class="selector"
